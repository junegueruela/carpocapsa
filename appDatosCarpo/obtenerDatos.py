...
## Obtenemos la predicción semanal de la AEMET para un municipio con su código.
...
## Dada una estación meteorológica, obtengo los datos climáticos desde la última medición
