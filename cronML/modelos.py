...
# Este modelo inicial calculaba datos por quincenas, lo he descartado y ahora utilizo el siguioente
def calcularModelo():
    # Obtenemos los municipios de los que tenemos vuelos y también una df de los datos de municipios
    ...
    for municipio in dfListaMunicipios['municipio']:
        ...
        # Por cada municipio obtengo un dataframe con todos los datos de tiempo
        ...
        # Calculo los días grados de de acuerdo a cada etapa de desarrollo
...
def calcularModeloSimple():
    ...
    for municipio in dfListaMunicipios['municipio']:
        ...
        # Calculo las condiciones ambientales de hace dos y tres semanas, por un lado
        # y de los 60 días anteriores al último mes por el otro
        # Lo hacemos así porque las condiciones ambientales determinan los distintos estadios de desarrollo
        # del insecto, desde el huevo a la larva, siendo un ciclo completo de varias semanas
        # Larva unos 60 días, pupa unos 15, más la semana pasada y la siguiente para adultos
